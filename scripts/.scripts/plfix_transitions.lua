...
-- This script can be used on its own and is automatically invoked by the plfix
-- script.
...
if dupes == 0 then
    print('No duplicate lines in transitions.tsv')
else
    print(string.format('Merged %d duplicate line%s in transitions.tsv', dupes, dupes == 1 and '' or 's'))
end
